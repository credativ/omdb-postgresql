...
\copy all_people            FROM PROGRAM 'bzcat www.omdb.org/data/all_people.csv.bz2' WITH (FORMAT CSV, HEADER TRUE, NULL '\N', ESCAPE '\')
\copy all_people_aliases    FROM PROGRAM 'bzcat www.omdb.org/data/all_people_aliases.csv.bz2' WITH (FORMAT CSV, HEADER TRUE, NULL '\N', ESCAPE '\')
\copy people_links          FROM PROGRAM 'bzcat www.omdb.org/data/people_links.csv.bz2' WITH (FORMAT CSV, HEADER TRUE, NULL '\N', ESCAPE '\')
\copy all_casts             FROM PROGRAM 'bzcat www.omdb.org/data/all_casts.csv.bz2' WITH (FORMAT CSV, HEADER TRUE, NULL '\N', ESCAPE '\')
\copy job_names             FROM PROGRAM 'bzcat www.omdb.org/data/job_names.csv.bz2' WITH (FORMAT CSV, HEADER TRUE, NULL '\N', ESCAPE '\')
\copy all_characters        FROM PROGRAM 'bzcat www.omdb.org/data/all_characters.csv.bz2' WITH (FORMAT CSV, HEADER TRUE, NULL '\N', ESCAPE '\')
...
\copy all_movie_aliases_iso FROM PROGRAM 'bzcat www.omdb.org/data/all_movie_aliases_iso.csv.bz2' WITH (FORMAT CSV, HEADER TRUE, NULL '\N', ESCAPE '\')
\copy all_votes             FROM PROGRAM 'bzcat www.omdb.org/data/all_votes.csv.bz2' WITH (FORMAT CSV, HEADER TRUE, NULL '\N', ESCAPE '\')
