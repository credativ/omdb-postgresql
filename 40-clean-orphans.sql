...
DELETE FROM movie_categories   c WHERE NOT EXISTS (SELECT * FROM categories p WHERE p.category_id = c.category_id);
DELETE FROM movie_keywords     c WHERE NOT EXISTS (SELECT * FROM movies p WHERE p.id = c.movie_id);
DELETE FROM movie_keywords     c WHERE NOT EXISTS (SELECT * FROM categories p WHERE p.category_id = c.category_id);
