...
CREATE TABLE people_links (source text, key text, person_id bigint, language_iso_639_1 varchar(2));
...
CREATE TABLE categories (category_id bigint, name text);
...
CREATE TABLE movie_aliases_iso (movie_id bigint, name text, language_iso_639_1 varchar(2), official_translation int);
